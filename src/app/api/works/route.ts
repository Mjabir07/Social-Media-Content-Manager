...
const createSchema = z.object({
  ...
  laborHours: z.number().nonnegative().max(100000).optional().nullable(),
  hourlyRateCents: z.number().int().nonnegative().optional().nullable(),
  operationalCents: z.number().int().nonnegative().optional().nullable(),
  hostingCents: z.number().int().nonnegative().optional().nullable(),
