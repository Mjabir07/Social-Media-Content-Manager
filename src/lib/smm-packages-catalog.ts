...
export const SMM_PACKAGES: SmmPackage[] = [
  ...
  },
  {
    ...
    monthlyStories: 10,
    deliverables: [
      "16 posts per month across selected platforms",
      "6 short-form Reels / video edits per month",
  ...
  },
  {
    ...
    monthlyStories: 12,
    deliverables: [
      "20 posts per month across all selected platforms",
