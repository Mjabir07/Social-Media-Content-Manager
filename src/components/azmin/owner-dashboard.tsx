        ...
        <aside className="relative hidden overflow-hidden bg-[#03142E] text-white lg:flex lg:flex-col">
          ...
          <div className="relative flex h-full flex-col px-4 py-4">
            ...
            <nav className="mt-4 space-y-1" aria-label="AZMIN navigation">
              ...
              <NavItem icon="spark" label="How it works" badge="Guide" href="/azmin/guide" />
              <NavItem icon="companies" label="Companies" badge="Live" href="/azmin/companies" />
              <NavItem icon="agents" label="Clients" href="/azmin/clients" />
              <NavItem icon="bell" label="Inbox" href="/azmin/inbox" />
              <NavItem icon="sales" label="Leads & sales" href="/azmin/leads" />
              <NavItem icon="finance" label="Quotations" href="/azmin/quotes" />
              <NavItem icon="projects" label="Projects" href="/azmin/projects" />
              ...
              <NavItem icon="marketing" label="Social Media" href="/azmin/smm" badge="Phase 1" />
              <NavItem icon="finance" label="Finance" href="/azmin/finance" />
            </nav>
            ...
            <nav className="mt-2 space-y-1.5">
              ...
              <NavItem icon="finance" label="Hourly rate" href="/azmin/settings/rate" />
